...
//!   `make`/`makefile`/`mk`, `cmake`, `proto`/`protobuf`, `perl`/`pl`,
//!   `cs`/`csharp`, `java`, and `lisp`/`scheme`/`scm`
...
const INFO_LANGS: &[(&[u8], Language)] = &[
    ...
    (b"conf", Language::Conf),
    (b"config", Language::Conf),
    (b"cs", Language::Csharp),
    (b"csharp", Language::Csharp),
    (b"cpp", Language::Cpp),
    (b"css", Language::Css),
    (b"csv", Language::Csv),
    (b"cxx", Language::Cpp),
    (b"dosini", Language::Ini),
    (b"go", Language::Go),
